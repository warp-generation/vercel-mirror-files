...
function getSelectedDNS() {
    if (document.getElementById('cf').checked) {
        ...
        return "45.155.204.190, 37.230.192.51";
...
async function generateConfig1() {  showWarningIfNeeded(async () => {
...
async function generateConfig2() { showWarningIfNeeded(async () => {
...
async function generateConfig3() { showWarningIfNeeded(async () => {
